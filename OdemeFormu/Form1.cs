...
namespace OdemeFormu
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Data Source=VENIVIDIVICI;Initial Catalog=BTKAkademi1;Integrated Security=True;Connect Timeout=30;Encrypt=False");
